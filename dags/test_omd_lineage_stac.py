...
SCHEMA_NAME = "MAXAR_BayofBengal_Cyclone_Mocha_May_23"
TABLE_X_FQN = f"{DATABASE_NAME}.{SCHEMA_NAME}.46_033111300111_1040010082988200"
TABLE_B_FQN = f"{DATABASE_NAME}.{SCHEMA_NAME}.46_033111300113_1040010082988200"
TABLE_Y_FQN = f"{DATABASE_NAME}.{SCHEMA_NAME}.46_033111300131_1040010082988200"
...
# Define DAG
with DAG(
    "test-lineage-stac-omd",
    default_args=default_args,
    description="An example DAG which tracks lineage using STAC API",
